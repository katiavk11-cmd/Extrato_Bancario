...
### 2. Eliminação de Duplicatas: Estratégia de Integridade
...
* **Como funciona:** Como usamos Records, o `.distinct()` compara cada campo. Se duas linhas tiverem exatamente a mesma conta, valor e data/hora, o Java mantém apenas uma, garantindo que o saldo final não seja inflado artificialmente.



### 3. Ordenação Cronológica
A ordenação é a "coreografia" dos dados.
